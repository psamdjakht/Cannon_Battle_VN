# Deploy Cannon Battle VN v1.4.3 lên Render
...
4. Log đúng phiên bản phải có: `Cannon Battle VN v1.4.3 đang chạy tại cổng ...`.
5. Mở Console trình duyệt phải thấy: `Cannon Battle VN client v1.4.3 loaded`.
